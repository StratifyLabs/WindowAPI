...
public:
  ...
  const NativeType * native_value() const {
    return &m_native_value;
  }
...
protected:
  void set_native_value(NativeType * value){
    m_native_pointer = value;
  }
...
protected:
  ...
  void set_native_value(const NativeType * value){
    m_native_pointer = value;
  }
